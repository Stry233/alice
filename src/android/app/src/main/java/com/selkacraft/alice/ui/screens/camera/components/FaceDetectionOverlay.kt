...
/**
 * Professional face detection overlay with smooth animations and clear feedback.
 *
 * Design principles:
 * - Smooth position interpolation (boxes glide, never jump)
 * - Clear selection feedback (pulse animation when switching faces)
 * - Bold, visible strokes that work on any background
 * - Graceful state transitions with animated colors
 */
@Composable
